...
botonComprar.addEventListener("click", (e) =>{
    ...
    let valorTotal = d.createElement('p');
    valorTotal.className = 'fs-2 fw-bold text-center p-4 border-top border-dark-subtle border-3 bg-secondary-subtle ';
    valorTotal.id = "total-productos"
    divContenido.appendChild(valorTotal);    
...
function CargarBanners(htmlid) {
    let contenedorBanners = document.querySelector('.contenedor-banners');
    ...
    bannersFiltrados.forEach(banner => {
        ...
        imgBanner.className = 'w-100 h-25';
